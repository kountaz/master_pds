...
public class MyFormatter extends SuperFormatter {
	public String outputFormatTypex(String pValue) {
	...
	public String inputFormatTypex(String pMessage) throws DocumentException {
		Document doc = DocumentHelper.parseText(pMessage);
		String value = doc.selectSingleNode("//doc").getText();
		return value;
	}
