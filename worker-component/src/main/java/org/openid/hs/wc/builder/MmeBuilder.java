...
public final class MmeBuilder extends WCBuilder {
	protected MmeBuilder() {
		super();
	}
	...
	public WorkerComponent build() throws BuildingException {
		...
		FrontEndService simulation = new MmeFrontEndServiceBean(kernel);
		MmeActivityService activity = new MmeActivityServiceBean(kernel);
		QosService qos = new QosServiceBean(kernel);
