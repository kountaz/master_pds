...
public class FormatDSLAM {
	...
	public ObjectForDSLAM inputFormatDSLAM(String pMessage) throws DocumentException {
		...
		//
		dslam.setAdresse_ip_fixe(doc.selectSingleNode("//root/adresse_ip_fixe")
				.getText());
		//
		dslam.setAdresse_ip_fixe(doc.selectSingleNode("//root/adresse_mac")
				.getText());
		//
	...
	public String outputFormatDSLAM(ObjectForDSLAM dslam) {
		...
		root.addElement("type_evenement").addText(dslam.getDate_de_souscription());
