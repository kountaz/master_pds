...
import org.openid.hs.scenario.ScenarioOfCOMMUTATOR;

public class ScenarioOfCOMMUTATORTest extends TestCase{
	ScenarioOfCOMMUTATOR scenario;
	@Before
	public void setUp(){
	...
	@Test
	public void testScenarioOfCOMMUTATOR(){
	...
	public void testStart(){
		...
		scenario = new ScenarioOfCOMMUTATOR( wc);
		scenario.start();
	}
